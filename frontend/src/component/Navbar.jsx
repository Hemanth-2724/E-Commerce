      ...
      <nav className="navbar">
        ...
        <div className="navbar-links">
          ...
          {user ? (
            ...
            <>
              <Link to="/" className="btn btn-ghost btn-sm" style={{ marginLeft: "0.5rem" }}>
                Sign In
              </Link>
              <Link to="/register" className="btn btn-gold btn-sm" style={{ marginLeft: "0.5rem", background: "var(--rose)", color: "#fff", padding: "0.4rem 1rem", borderRadius: "8px", fontWeight: "600", textDecoration: "none" }}>
                Sign Up
              </Link>
            </>
          )}
      ...
      >
        ...
        {user ? (
          ...
          <div style={{ padding: "1rem 1.5rem 2rem", borderTop: "1px solid rgba(255,255,255,0.06)", display: "flex", gap: "0.5rem" }}>
            <Link to="/" className="btn btn-ghost" style={{ flex: 1, justifyContent: "center" }} onClick={closeMenu}>Sign In</Link>
            <Link to="/register" className="btn btn-rose" style={{ flex: 1, justifyContent: "center", background: "var(--rose)", color: "#fff", border: "none" }} onClick={closeMenu}>Sign Up</Link>
          </div>
        )}
      </div>
